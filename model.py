...
# download('https://s3.amazonaws.com/video.udacity-data.com/topher/2016/December/584f6edd_data/data.zip','data.zip') #s3 path of the dataset provided by u        print("All the files are downloaded")
...
with ZipFile('data.zip','r') as zipf:
    zipf.extractall('data_unzipped')
#ZipFile.extractall(path='home>workspace>CarND-Behavioral-Cloning-P3>data.zip', members='data', pwd=None)
...
with open('./data_unzipped/data/driving_log.csv') as csvfile: #currently after extracting the file is present in this path
        ...
        for offset in range(0, num_samples, batch_size):
            ...
            for batch_sample in batch_samples:
                    for i in range(0,3): #we are taking 3 images, first one is center, second is left and third is right
                        ...
                        name = './data_unzipped/data/IMG/'+batch_sample[i].split('/')[-1]
